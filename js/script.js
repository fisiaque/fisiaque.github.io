...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const bioMessages = [
    "Welcome to Baya's site, here you will be able to find help.",
    '"Hello, World!"',
  ];
  let bioText = "";
  let bioIndex = 0;
  ...
  homeButton.addEventListener("click", () => {
    switchTheme("assets/backgrounds/home.mp4", homeMusic, "home-theme");
  });
  ...
  animeButton.addEventListener("click", () => {
    switchTheme("assets/backgrounds/anime.mp4", animeMusic, "anime-theme");
  });
  ...
  carButton.addEventListener("click", () => {
    switchTheme("assets/backgrounds/car.mp4", carMusic, "car-theme");
  });
